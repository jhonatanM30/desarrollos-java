...
@NoArgsConstructor
@AllArgsConstructor
public class ParametrizacionMiddlewareUpdateRequestDto {
    ...
    @NotEmpty(message = "Debe incluir al menos un parámetro para actualizar")
    @Valid
    private List<ParametrizacionMiddlewareUpdateDto> parametros;
}
