...
@NoArgsConstructor
@AllArgsConstructor
public class MwServiciosRegionalesDto {
    ...
    @Size(max = 1, message = "El estado no puede exceder 1 caracteres")
    private String estado;

    @Size(max = 200, message = "La ubicación no puede exceder 200 caracteres")
    private String ubicacion;

    @Size(max = 2, message = "El log activado no puede exceder 2 caracteres")
